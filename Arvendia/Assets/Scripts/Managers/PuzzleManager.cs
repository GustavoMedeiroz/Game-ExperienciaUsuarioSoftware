...
public class PuzzleManager : MonoBehaviour
{
    ...
    [SerializeField] private PlayerDialog dialogIncomplete;
    ...
    void Update()
    {
        ...
        if (!shuffling && CheckCompletion())
        {
            ...
            uIManager.ClosePuzzlePanel();
            dialogIncomplete.CanShow = false;
            dialogComplete.CanShow = true;
            quest.QuestCompleted = true;
            dialogManager.ShowDialogue(dialogComplete);
